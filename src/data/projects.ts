export const projects = [
  {
    ...
    problem:
      'Teams need real-time visibility into API uptime and performance without manual checking.',
    architecture:
      'Node.js backend with scheduled workers polling endpoints, storing results in PostgreSQL, and a React dashboard.',
    techStack: [
      'React',
      'TypeScript',
      'Node.js',
